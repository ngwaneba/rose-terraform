...
resource "aws_subnet" "public_subnet_az1" {
  ...
  tags = {
    Name = "${var.project-name}-${var.environment}-public-az1"
  }
}
...
resource "aws_subnet" "public_subnet_az2" {
  ...
  tags = {
    Name = "${var.project-name}-${var.environment}-public-az2"
  }
}
...
resource "aws_subnet" "private_app_subnet_az1" {
  ...
  tags = {
    Name = "${var.project-name}-${var.environment}-private-app-az1"
  }
}
...
resource "aws_subnet" "private_app_subnet_az2" {
  ...
  tags = {
    Name = "{var.project-name}-${var.environment}-private-app-az2"
  }
}
...
resource "aws_subnet" "private_data_subnet_az1" {
  ...
  tags = {
    Name = "${var.project-name}-${var.environment}-private-data-az1"
  }
}
...
resource "aws_subnet" "private_data_subnet_az2" {
  ...
  tags = {
    Name = "${var.project-name}-${var.environment}-private-data-az2"
  }
}
